          ...
          <Card className="rounded-2xl border border-border shadow-sm">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                Class Teachers
                <CreateTeacherDialog
                  mutateAsync={async ({ class_id, teacher_id }) => {
                    await axios.post(
                ...
                <TableBody>
                  {loadingClassTeachers ? (
                    ...
                    <TableRow>
                      ...
                      >
                        Error: {classTeachersError.message}
                      </TableCell>
                    </TableRow>
                    ...
                    classTeachers.map((ct) => (
                      <TableRow key={ct.class_teacher_id}>
                        <TableCell>{ct.class.name}</TableCell>
                        <TableCell>{ct.class.grade_level}</TableCell>
                        <TableCell>
                          {ct.teacher.first_name} {ct.teacher.last_name}
                        </TableCell>
