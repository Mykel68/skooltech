              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                    <ListItem href="#services" title="Exam Management">
                      Comprehensive exam creation, scheduling, and grading
                      system
                    </ListItem>
                    <ListItem href="#services" title="Result Processing">
                      Automated result calculation and report card generation
                    </ListItem>
                    <ListItem href="#services" title="Fee Management">
                      Streamlined school fee payment and tracking
                    </ListItem>
                    <ListItem href="#services" title="Student Portal">
                      Personalized access for students to view results and
                      resources
                    </ListItem>
                  </ul>
                </NavigationMenuContent>
