...
export default function Footer() {
	...
	return (
		<footer className='relative px-4 md:px-6 lg:px-12 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden'>
					...
					<div className='lg:col-span-4 space-y-8'>
						<div className='group'>
							...
							<p className='text-slate-300 mb-8 text-md leading-relaxed'>
								...
								innovative technology solutions for exam
								management, result processing, and comprehensive
