...
export default function About() {
	...
	return (
		<section className='relative py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-900 dark:via-slate-900 dark:to-indigo-950/20'>
					...
					>
						{stats.map((stat, i) => {
							...
							return (
								...
								>
									<div className='absolute inset-0 bg-gradient-to-r ${stat.color} rounded-2xl blur opacity-25 group-hover:opacity-40 transition-opacity' />
									<div className='relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300'>
										<div
						...
						>
							...
							<div className='relative bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-3xl p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-300'>
								...
								<p className='text-slate-600 dark:text-slate-300 mb-8 leading-relaxed'>
									...
									simplify administration, enhance teaching,
						...
						>
							...
							<div className='relative bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-3xl p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-300'>
								...
								<p className='text-slate-600 dark:text-slate-300 mb-8 leading-relaxed'>
									...
									technology solutions, creating a future
									where every school has access to powerful,
