...
export default function ModernCTAUI() {
	...
	const contactMethods = [
		{
			icon: Mail,
			title: 'Email Us',
			description: 'info@skooltech.com',
	...
	const features = [
		{ icon: Users, text: '10,000+ Schools Trust Us' },
		{ icon: Zap, text: 'Setup in 2-4 Weeks' },
			...
			<div className='relative z-10 px-6 py-20'>
				...
				<div className='text-center mb-20'>
					...
					<p className='text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12'>
						Join thousands of educators who've revolutionized their
						institutions with SkoolTech. Experience the future of
						...
						<div className='bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 p-8 shadow-2xl'>
							...
							{!isSubmitted ? (
								<>
									<div className='text-center mb-6'>
										...
										<p className='text-gray-300'>
											Tell us about your school and we'll
								...
								<div className='text-center py-8'>
									...
									<p className='text-gray-300'>
										Thank you for your interest. We'll get
