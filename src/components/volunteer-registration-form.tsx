...
export default function VolunteerRegistrationForm() {
  ...
  const [startDate, setStartDate] = useState<Date | undefined>(new Date("2023-06-16"))
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">By registering, you will be able to join our team!</p>
      </div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="w-full justify-start text-left font-normal">
                  ...
                  {startDate ? format(startDate, "MM/dd/yyyy") : "Select a date"}
                </Button>
              </PopoverTrigger>
          ...
          {skillOptions.map((skill) => (
            <Badge
              ...
              className={cn(
                ...
                selectedSkills.includes(skill) ? "bg-primary text-primary-foreground" : "bg-background text-foreground",
              )}
      ...
      {/* Submit Button */}
      <Button type="submit" className="w-full mt-8 py-6 text-lg bg-green-500 hover:bg-green-600">
        Submit
      </Button>
    </form>
  )
